...
class ExecuteWithdrawEvent():
    ...
    def to_entity(self) -> ExecuteWithdrawEntity:
        props = ExecuteWithdrawEntity.__dataclass_fields__.keys()
        kv = {prop: self.event[prop] for prop in props}
        return ExecuteWithdrawEntity(**kv)
